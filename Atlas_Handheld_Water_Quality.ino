...
return; 
 ...
 short read_channel(short channel){
       ...
       if(channel==0){                                                              //the DO probe needs temperature compensation, so we call temp first
          ...
          display.drawRect(12, 57, 118, 8, BLACK);                                   //first, print a black rectangle in that area
          display.fillRect(12, 57, 118, 8, BLACK);                                   //then fill it....this will essentially clear that space so you can print the new date
     ...
     myserial.print("r");                                                      //the command to tell the atlas probes you want some info
